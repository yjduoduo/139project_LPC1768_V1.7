...
{  
	...
	else
	{
		...
		Displaynumber(1,2,18,0x0A);	
		DisplayJBHZK(1,2,32,((hz[24]<<8)+hz[25]));
		DisplayJBHZK(1,2,48,((hz[26]<<8)+hz[27]));
		DisplayJBHZK(2,2,0,((hz[28]<<8)+hz[29]));
		DisplayJBHZK(2,2,16,((hz[30]<<8)+hz[31]));
		DisplayJBHZK(2,2,32,((hz[32]<<8)+hz[33]));
		
		//设置蜂鸣器
		Displaynumber(1,4,10,7);//display 7
		Displaynumber(1,4,18,0x0A);	

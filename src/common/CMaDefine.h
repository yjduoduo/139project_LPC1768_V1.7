...
#define  MAX_LOOP   200  //最大回路数
#define  DEPART    200  //最大防区数
#define  MAX_COMP    50  //防区最部件数
#define  COMP_START  (1)
//#define  CIRADDRESS    100  //回路地址最大值
#define  MASKSUM    50  //屏蔽数组

/////////////////////////////////////////////////////////////////////////////
//蜂鸣器操作定义
#define BEEPOn() 		FIO2SET |= 1<<3    //开蜂鸣器
#define BEEPOff() 	FIO2CLR |= 1<<3     //关蜂鸣器
/////////////////////////////////////////////////////////////////////////////
//LED

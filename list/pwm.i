...
#line 15 "..\\src\\Hardware\\PWM.c"
#line 16 "..\\src\\Hardware\\PWM.c"
#line 1 "..\\inc\\type.h"
...
#line 112 "..\\src\\Hardware\\PWM.c"
    ...
    (*(volatile unsigned long *)(0x4002C000 + 0x10)) |= 0x040;	  


	(*(volatile unsigned long *)(0x40018000 + 0x04)) = 0x00000002;	  
    (*(volatile unsigned long *)(0x40018000 + 0x0C)) = 0x00;		 
	(*(volatile unsigned long *)(0x40018000 + 0x14)) = (1 << 0);	
 				
	(*(volatile unsigned long *)(0x40018000 + 0x18)) = 0;	 



	(*(volatile unsigned long *)(0x40018000 + 0x40)) = 0;
...
{			
	...
	(*(volatile unsigned long *)(0x40018000 + 0x18)) = cycle;		 
...
void PWM1_Stop( void )
{
	...
	(*(volatile unsigned long *)(0x40018000 + 0x4C)) = 0;
	(*(volatile unsigned long *)(0x40018000 + 0x04)) = 0x00;		 

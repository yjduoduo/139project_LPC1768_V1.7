...
void Led_Run_Init(void)
{
    ...
    (*(volatile unsigned long *)(0x4002C000 + 0x00)) &=~(1<<30);
    (*(volatile unsigned long *)(0x2009C000 + 0x00)) |= (1<<15);
    (*(volatile unsigned long *)(0x2009C000 + 0x18)) |= (1<<15);
}
void Led_Run_On(void)
{
    (*(volatile unsigned long *)(0x2009C000 + 0x18)) |= (1<<15);
...
void Led_Run_Off(void)
{
    (*(volatile unsigned long *)(0x2009C000 + 0x1C)) |= (1<<15);
}

void Led_Silence_Init(void)
{
    
    (*(volatile unsigned long *)(0x4002C000 + 0x04)) &= ~(1<<0);
    (*(volatile unsigned long *)(0x2009C000 + 0x00)) |= (1<<16);
    (*(volatile unsigned long *)(0x2009C000 + 0x18)) |= (1<<16);
}
void Led_Silence_On(void)
{
    (*(volatile unsigned long *)(0x2009C000 + 0x18)) |= (1<<16);
...
void Led_Silence_Off(void)
{
    (*(volatile unsigned long *)(0x2009C000 + 0x1C)) |= (1<<16);
}

void Led_Wireless_Init(void)
{
    (*(volatile unsigned long *)(0x4002C000 + 0x10)) &=~(1<8);
    (*(volatile unsigned long *)(0x2009C000 + 0x40)) |= (1<<4);
    (*(volatile unsigned long *)(0x2009C000 + 0x58)) |= (1<<4);
}
void Led_Wireless_On(void)
{
    (*(volatile unsigned long *)(0x2009C000 + 0x58)) |= (1<<4);
...
void Led_Wireless_Off(void)
{
    (*(volatile unsigned long *)(0x2009C000 + 0x5C)) |= (1<<4);
}


void Led_Fault_Init(void)
{
    (*(volatile unsigned long *)(0x4002C000 + 0x10)) &=~(1<10);
    (*(volatile unsigned long *)(0x2009C000 + 0x40)) |= (1<<5);
    (*(volatile unsigned long *)(0x2009C000 + 0x58)) |= (1<<5);
}
void Led_Fault_On(void)
{
    (*(volatile unsigned long *)(0x2009C000 + 0x58)) |= (1<<5);
...
void Led_Fault_Off(void)
{
    (*(volatile unsigned long *)(0x2009C000 + 0x5C)) |= (1<<5);
}


void Led_Fire_Init(void)
{
    (*(volatile unsigned long *)(0x4002C000 + 0x10)) &=~(1<12);
    (*(volatile unsigned long *)(0x2009C000 + 0x40)) |= (1<<6);
    (*(volatile unsigned long *)(0x2009C000 + 0x58)) |= (1<<6);
}
void Led_Fire_On(void)
{
    (*(volatile unsigned long *)(0x2009C000 + 0x58)) |= (1<<6);
...
void Led_Fire_Off(void)
{
    (*(volatile unsigned long *)(0x2009C000 + 0x5C)) |= (1<<6);
}

...
#line 16 "..\\src\\Board\\CRelay.c"


void Relay_Init(void)
{
    
    (*(volatile unsigned long *)(0x4002C000 + 0x00)) &=~(1<<0);

    (*(volatile unsigned long *)(0x4002C000 + 0x00)) &=~(1<<1);
	
    (*(volatile unsigned long *)(0x2009C000 + 0x00)) |= (1<<0) | (1<<1);
    (*(volatile unsigned long *)(0x2009C000 + 0x1C)) |= (1<<0) | (1<<1);	
}

void Fire_Relay_On(void)
{
	(*(volatile unsigned long *)(0x2009C000 + 0x18)) |= (1<<0);
}
void Fire_Relay_Off(void)
{
	(*(volatile unsigned long *)(0x2009C000 + 0x1C)) |= (1<<0);
}
void Fault_Relay_On(void)
{
	(*(volatile unsigned long *)(0x2009C000 + 0x18)) |= (1<<1);
}
void Fault_Relay_Off(void)
{
	(*(volatile unsigned long *)(0x2009C000 + 0x1C)) |= (1<<1);
}

...
void CompSet_Menu(uint16 temp,uint16 tmp,uint8 tm,uint8 sflag,uint8 sureflag)
{
 ...
 if(sflag == 2)
    ...
    {
        menu_ops_done();
    }else if(0x10 == sureflag){
        menu_press_ok_save();
    }
    else if(0x05 == sureflag)
    {
        menu_opsing();
    }
    else if(0x06 == sureflag)
    {
        menu_deling();
    }
    else if(0x07 == sureflag)
    {
        menu_comp_masked();
    }
    else if(0x08 == sureflag)
    {
        menu_comp_started();
    }

#line 1 "..\\src\\MenuCtrl\\CTaskSure.c"
...
#line 17 "..\\src\\MenuCtrl\\CTaskSure.c"
...
void reset_ok(void);
#line 18 "..\\src\\MenuCtrl\\CTaskSure.c"
#line 1 "..\\src\\MenuCtrl\\CGetGrap.h"
...
#line 19 "..\\src\\MenuCtrl\\CTaskSure.c"
...
#line 26 "..\\src\\MenuCtrl\\tasklist.h"
...
#line 20 "..\\src\\MenuCtrl\\CTaskSure.c"
...
#line 23 "..\\src\\MenuCtrl\\CTaskSure.c"
...
#line 16 "..\\src\\12UARTHandle\\CComHandle.h"
#line 169 "..\\src\\12UARTHandle\\CComHandle.h"
...
#line 29 "..\\src\\MenuCtrl\\CTaskSure.c"
#line 1 "..\\src\\Menu\\CSysReset.h"
...
#line 30 "..\\src\\MenuCtrl\\CTaskSure.c"
...
#line 31 "..\\src\\MenuCtrl\\CTaskSure.c"
#line 1 "..\\src\\12UARTHandle\\CComPara.h"
...
#line 16 "..\\src\\12UARTHandle\\CComPara.h"
#line 141 "..\\src\\12UARTHandle\\CComPara.h"


 


#line 32 "..\\src\\MenuCtrl\\CTaskSure.c"
...
#line 33 "..\\src\\MenuCtrl\\CTaskSure.c"
...
#line 34 "..\\src\\MenuCtrl\\CTaskSure.c"
...
#line 35 "..\\src\\MenuCtrl\\CTaskSure.c"
#line 36 "..\\src\\MenuCtrl\\CTaskSure.c"
#line 1 "..\\src\\MenuCtrl\\CTaskReturn.h"
...
#line 37 "..\\src\\MenuCtrl\\CTaskSure.c"
...
#line 38 "..\\src\\MenuCtrl\\CTaskSure.c"
...
void factory_ok(void)
{
    ...
    while(1)
    {
        ...
        if(((*(volatile unsigned long *)(0x2009C000 + 0x14))&(1 << 10)))
            break;
    }
...
void get_local_addr(void)
{
    ...
    SetBaseAddr(0,(get_basic_localaddr()/100));
    SetBaseAddr(1,(get_basic_localaddr()%100/10));
    SetBaseAddr(2,(get_basic_localaddr()%100%10));
...
void menu_setup_datetime_ok(void)
{
    ...
    DateMod_Menu(GetYear(),GetMonth(),GetDay(),GetHour(),GetMintue(),GetSecond(),1,0x00);
...
void query_historyrecord_ok(void)
{
    ...
    History_Menu(hist_item(row),histinfo.circleaddr,
                 ...
                 histinfo.part,&histinfo.dateyear);
...
void menu_set_localaddr_ok(void)
{
    ...
    {
        Local_Menu(GetBaseAddr(0),GetBaseAddr(1),GetBaseAddr(2),Get_zone_bit(0),
                   Get_zone_bit(1),Get_zone_bit(2),GetLocalParaSel(),0x04);
        return;
    }
    ...
    Local_Menu(GetBaseAddr(0),GetBaseAddr(1),GetBaseAddr(2),Get_zone_bit(0),
               Get_zone_bit(1),Get_zone_bit(2),GetLocalParaSel(),0x02);

    set_basic_localaddr(local_addr_value());
    save_basic_info();
    Local_Menu(GetBaseAddr(0),GetBaseAddr(1),GetBaseAddr(2),Get_zone_bit(0),
               Get_zone_bit(1),Get_zone_bit(2),GetLocalParaSel(),0x01);
...
void setup_menu_deal(void)
{
    ...
    case 3:
        ...
        if(row <0 || 0xff == row){
            lcd_printf("row err!:%d\n",row);
            CompSet_Menu(GetCompSetDep(),GetCompSetNum(),GetComSetSelSet(),GetComSet_seltab(),0x04);
            return;
        }
        lcd_printf("row:%d\n",row);
        ...
        {
        case (0x00):
            lcd_printf("maskinfo:%d\n",get_mask_info(row));
            if(get_mask_info(row) == (0x00))
            {
                CompSet_Menu(GetCompSetDep(),GetCompSetNum(),GetComSetSelSet(),GetComSet_seltab(),0x08);
                return;
            }else{
                
                SetReg_CNodeInfo(get_comp_ciraddr(row));
                CompSet_Menu(GetCompSetDep(),GetCompSetNum(),GetComSetSelSet(),GetComSet_seltab(),0x03);
                set_mask_info(row,(0x00));
            }
            break;

        case (0x01):
            if(get_mask_info(row) == (0x01))
            {
                CompSet_Menu(GetCompSetDep(),GetCompSetNum(),GetComSetSelSet(),GetComSet_seltab(),0x07);
                return;
            }else{
                ...
                set_mask_info(row,(0x01));
            }
            break;
        case (0x02):
            lcd_printf("->>preparing to delete component\n");
            while((*(volatile unsigned long *)(0x2009C000 + 0x14))&(1 << 10))
            {
                if(j==1)
                {
            ...
            if(delflag==1)
            {
                ...
                CompSet_Menu(GetCompSetDep(),GetCompSetNum(),GetComSetSelSet(),GetComSet_seltab(),0x06);
                lcd_printf("row %d deleted!\n",row);
        ...
        CompSet_Menu(GetCompSetDep(),GetCompSetNum(),GetComSetSelSet(),GetComSet_seltab(),0x09);

        break;
    case 4:
        PCF8563_Set(&timedate);

        DateMod_Menu(GetYear(),GetMonth(),GetDay(),GetHour(),GetMintue(),GetSecond(),GetSelTime(),0x02);

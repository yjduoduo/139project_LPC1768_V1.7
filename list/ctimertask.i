#line 1 "..\\src\\common\\CTimerTask.c"
...
#line 17 "..\\src\\common\\CTimerTask.c"
#line 18 "..\\src\\common\\CTimerTask.c"
#line 19 "..\\src\\common\\CTimerTask.c"
...
tBoolean SetTmrTickTask (uint8 taskID, uint32 SetMSec) 
{
    if(taskID >= 50)
	{
        return (0);
	...
	if(stTaskTimer[taskID].IsUsing == (1))
		KillTickTask(taskID);
...
void SetTickTaskSign (uint8 taskID)
{
    if(taskID >= 50)
        return;

    stTaskTimer[taskID].Sign = (1);

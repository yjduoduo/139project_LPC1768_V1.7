#line 1 "..\\src\\Hardware\\Timer\\CTime.c"
...
#line 15 "..\\src\\Hardware\\Timer\\CTime.c"
...
#line 16 "..\\src\\Hardware\\Timer\\CTime.c"
...
#line 17 "..\\src\\Hardware\\Timer\\CTime.c"
...
#line 18 "..\\src\\Hardware\\Timer\\CTime.c"
...
#line 31 "..\\src\\Board\\key.h"



#line 40 "..\\src\\Board\\key.h"



#line 49 "..\\src\\Board\\key.h"
...
#line 19 "..\\src\\Hardware\\Timer\\CTime.c"
#line 1 "..\\src\\13CirCon\\CAddressCount.h"
...
#line 22 "..\\src\\Hardware\\Timer\\CTime.c"
...
#line 23 "..\\src\\Hardware\\Timer\\CTime.c"
...
void reset_ok(void);
#line 24 "..\\src\\Hardware\\Timer\\CTime.c"
...
extern  void  Init_CSysRunFlag(void);


extern  void  Set_CSys100usFlag(void);
extern  void  Clr_CSys100usFlag(void);
extern  uint8 Get_CSys100usFlag(void);


extern  void  Set_CSys20msFlag(void);
extern  void  Clr_CSys20msFlag(void);
extern  uint8 Get_CSys20msFlag(void);



extern  void  Set_CSys100msFlag(void);
extern  void  Clr_CSys100msFlag(void);
extern  uint8 Get_CSys100msFlag(void);



extern  void  Set_CSys500msFlag(void);
extern  void  Clr_CSys500msFlag(void);
extern  uint8 Get_CSys500msFlag(void);



extern  void  Set_CSys1SFlag(void);
extern  void  Clr_CSys1SFlag(void);
extern  uint8 Get_CSys1SFlag(void);


extern  void  Set_CSys2SFlag(void);
extern  void  Clr_CSys2SFlag(void);
extern  uint8 Get_CSys2SFlag(void);


extern  void  Set_CSys5SFlag(void);
extern  void  Clr_CSys5SFlag(void);
extern  uint8 Get_CSys5SFlag(void);




extern  void  Set_CSys1MFlag(void);
extern  void  Clr_CSys1MFlag(void);
extern  uint8 Get_CSys1MFlag(void);
...
#line 25 "..\\src\\Hardware\\Timer\\CTime.c"
...
#line 26 "..\\src\\Hardware\\Timer\\CTime.c"
...
void timern_enable(uint8 timern)
{
    ...
    case 0:
        ...
        NVIC_SetPriority(TIMER0_IRQn, (0x02 << 3)); 
        break;
    case 1:
        NVIC_EnableIRQ(TIMER1_IRQn);
        NVIC_SetPriority(TIMER1_IRQn, (0x06 << 3)); 
        break;
    case 2:
        NVIC_EnableIRQ(TIMER2_IRQn);
        NVIC_SetPriority(TIMER2_IRQn, (0x09 << 3)); 
        break;
    case 3:
        NVIC_EnableIRQ(TIMER3_IRQn);
        NVIC_SetPriority(TIMER3_IRQn, (0x0A << 3)); 
        break;
    default:
        break;
    }
...
void init_timer(uint8 timer_num, uint32 TimerInterval)  
{
    if ( timer_num == 0 )
    {
        (*(volatile unsigned long *)(0x400FC000 + 0x0C4)) |= (0x01<<1);
        (*(volatile unsigned long *)(0x40004000 + 0x70)) = 0x00;
        (*(volatile unsigned long *)(0x40004000 + 0x04))  = 0x02;
        (*(volatile unsigned long *)(0x40004000 + 0x00))   = 1;
        (*(volatile unsigned long *)(0x40004000 + 0x08))   = 0;
        (*(volatile unsigned long *)(0x40004000 + 0x0C))   = 0;
        (*(volatile unsigned long *)(0x40004000 + 0x18)) = TimerInterval;
        (*(volatile unsigned long *)(0x40004000 + 0x14)) = 3;				 
        (*(volatile unsigned long *)(0x40004000 + 0x04)) = 1;
        timern_enable(0);

    }
    if ( timer_num == 1 )
    {
        (*(volatile unsigned long *)(0x400FC000 + 0x0C4)) |= (0x1<<2);
        (*(volatile unsigned long *)(0x40008000 + 0x70)) = 0x00;
        (*(volatile unsigned long *)(0x40008000 + 0x04))  = 0x02;
        (*(volatile unsigned long *)(0x40008000 + 0x00))   = 1;
        (*(volatile unsigned long *)(0x40008000 + 0x08))   = 0;
        (*(volatile unsigned long *)(0x40008000 + 0x0C))   = 0;
        (*(volatile unsigned long *)(0x40008000 + 0x18)) = TimerInterval;
        (*(volatile unsigned long *)(0x40008000 + 0x14)) = 3;				 

        timern_enable(1);
        (*(volatile unsigned long *)(0x40008000 + 0x04)) = 1;
    }
    if ( timer_num == 2 )
    {
        (*(volatile unsigned long *)(0x400FC000 + 0x0C4)) |= (0x1<<22);
        (*(volatile unsigned long *)(0x40090000 + 0x70)) = 0x00;
        (*(volatile unsigned long *)(0x40090000 + 0x04))  = 0x02;
        (*(volatile unsigned long *)(0x40090000 + 0x00))   = 1;
        (*(volatile unsigned long *)(0x40090000 + 0x08))   = 0;
        (*(volatile unsigned long *)(0x40090000 + 0x0C))   = 0;
        (*(volatile unsigned long *)(0x40090000 + 0x18)) = TimerInterval;
        (*(volatile unsigned long *)(0x40090000 + 0x14)) = 3;				 
        timern_enable(2);
        (*(volatile unsigned long *)(0x40090000 + 0x04)) = 1;
    }
    if ( timer_num == 3 )
    {
        (*(volatile unsigned long *)(0x400FC000 + 0x0C4)) |= (0x1<<23);
        (*(volatile unsigned long *)(0x40094000 + 0x70)) = 0x00;
        (*(volatile unsigned long *)(0x40094000 + 0x04))  = 0x02;
        (*(volatile unsigned long *)(0x40094000 + 0x00))   = 1;
        (*(volatile unsigned long *)(0x40094000 + 0x08))   = 0;
        (*(volatile unsigned long *)(0x40094000 + 0x0C))   = 0;
        (*(volatile unsigned long *)(0x40094000 + 0x18)) = TimerInterval;
        (*(volatile unsigned long *)(0x40094000 + 0x14)) = 3;				 
        timern_enable(3);
        (*(volatile unsigned long *)(0x40094000 + 0x04)) = 1;
    }
}
...
void  TIMER1_IRQHandler (void)
{
    Eint_Dis();
    T1Int_CTimeCtrl();
    (*(volatile unsigned long *)(0x40008000 + 0x00))   = 0x0f;
    Eint_En();
}
...
{
    Scan_Key();
    (*(volatile unsigned long *)(0x40090000 + 0x00))   = 0x0f;
}
...
void OffLcd(void)
{
    if((*(volatile unsigned long *)(0x2009C000 + 0x14))&0x66000c00)
    {
        (*(volatile unsigned long *)(0x2009C000 + 0x5C)) |= (1<<9); 
        vClrScreenMask();
    }
}
...
void OnLCD(void)
{
    (*(volatile unsigned long *)(0x2009C000 + 0x58)) |= (1<<9); 
    vScreenMaskFlag=0;
}
...
void disable_timer( uint8 timer_num )
{
    if ( timer_num == 0 )
    {
        (*(volatile unsigned long *)(0x40004000 + 0x04)) = 0;
    }
    else if ( timer_num == 1 )
    {
        (*(volatile unsigned long *)(0x40008000 + 0x04)) = 0;
    }
    else if ( timer_num == 2 )
    {
        (*(volatile unsigned long *)(0x40090000 + 0x04)) = 0;
    }
    else if ( timer_num == 3 )
    {
        (*(volatile unsigned long *)(0x40094000 + 0x04)) = 0;
    }
    return;
}
...
void reset_timer( uint8 timer_num )
{
    ...
    if ( timer_num == 0 )
    {
        regVal = (*(volatile unsigned long *)(0x40004000 + 0x04));
        regVal |= 0x02;
        (*(volatile unsigned long *)(0x40004000 + 0x04)) = regVal;
    }
    else if ( timer_num == 1 )
    {
        regVal = (*(volatile unsigned long *)(0x40008000 + 0x04));
        regVal |= 0x02;
        (*(volatile unsigned long *)(0x40008000 + 0x04)) = regVal;
    }
    else if ( timer_num == 2 )
    {
        regVal = (*(volatile unsigned long *)(0x40090000 + 0x04));
        regVal |= 0x02;
        (*(volatile unsigned long *)(0x40090000 + 0x04)) = regVal;
    }
    else if ( timer_num == 3 )
    {
        regVal = (*(volatile unsigned long *)(0x40094000 + 0x04));
        regVal |= 0x02;
        (*(volatile unsigned long *)(0x40094000 + 0x04)) = regVal;
    }
    return;
}

#line 1 "..\\src\\CTimeCtrl\\CTimeCtrl.c"
...
static  uint16  m_AnsStatTime[]={(2*(1000/100)),(9*(1000/100)),(9*(1000/100)),(9*(1000/100))};
static  uint16  m_AnsDataTime[]={(2*(1000/100)),(2*(1000/100)),(9*(1000/100)),(9*(1000/100))};
...
extern  void  InitC_CSysRunFlag(void);

extern  void  Clr20ms_CSysRunFlag(void);
extern  void  Set20ms_CSysRunFlag(void);
extern  uint8 Get20ms_CSysRunFlag(void);

extern  void  Clr50ms_CSysRunFlag(void);
extern  void  Set50ms_CSysRunFlag(void);
extern  uint8 Get50ms_CSysRunFlag(void);

extern  void  ClrReset_CSysRunFlag(void);
extern  void  SetReset_CSysRunFlag(void);
extern  uint8 GetReset_CSysRunFlag(void);

extern  void  ClrReg_CSysRunFlag(void);
extern  void  SetReg_CSysRunFlag(void);
extern  uint8 GetReg_CSysRunFlag(void);

extern  void  ClrAlarm_CSysRunFlag(void);
extern  void  SetAlarm_CSysRunFlag(void);
extern  uint8 GetAlarm_CSysRunFlag(void);

extern  void  ClrDisHis_CSysRunFlag(void);
extern  void  SetDisHis_CSysRunFlag(void);
extern  uint8 GetDisHis_CSysRunFlag(void);

extern  void  Clr5s_CSysRunFlag(void);
extern  void  Set5s_CSysRunFlag(void);
extern  uint8 Get5s_CSysRunFlag(void);

extern  void  Clr1s_CSysRunFlag(void);
extern  void  Set1s_CSysRunFlag(void);
extern  uint8 Get1s_CSysRunFlag(void);

extern  void  Clr1m_CSysRunFlag(void);
extern  void  Set1m_CSysRunFlag(void);
extern  uint8 Get1m_CSysRunFlag(void);

extern  void  Clr100ms_CSysRunFlag(void);
extern  void  Set100ms_CSysRunFlag(void);
extern  uint8 Get100ms_CSysRunFlag(void);

extern void  Clr40ms_CSysRunFlag(void);
extern void  Set40ms_CSysRunFlag(void);
extern uint8 Get40ms_CSysRunFlag(void);
 
 
 

#line 122 "..\\src\\CRunCtrl\\CSysRunFlag.h"
...
extern  void  Init_CLpAnsCtrl(void); 


extern  uint8 GetData_CLpAnsCtrl(uint8 vComm,uint8 vState); 


extern  void  SetData_CLpAnsCtrl(uint8 vSndData);


extern  void  OutData_CLpAnsCtrl(uint8 vId); 


extern  void  OutState_CLpAnsCtrl(uint8 vId);  
...
#line 102 "..\\src\\CLoopCtrl\\CLpAnsCtrl.h"
...
void  Init_CTimeCtrl(void)
{
    ...
    Init_CLpCkCtrl();
    Init_CNodeInfo();
    ClrDisHis_CSysRunFlag(); 
}

void  IncT0Count_CTimeCtrl(void)
{
    if(vRunTime0 < (800*(1000/100)))
    {
        vRunTime0++;
    }

    if(vRunTime0 > (50*(1000/100)))
    {
        if(GetSys_CLpScanCtrl())   
        {
            ClrSys_CLpScanCtrl();
        }
...
void  SetCommT0_CTimeCtrl(void)
{
    if(vRunTime0 > (380*(1000/100)))  
    {
        Init_CLpScanCtrl();
        SetSys_CLpScanCtrl();
        SetDisHis_CSysRunFlag(); 
        return ;
    }
    ...
    if(vRunTime0 < (10*(1000/100)))  
    {
        SaveComm_CTimeCtrl(0);
    ...
    if(vRunTime0 < (14*(1000/100)))  
    {
        SaveComm_CTimeCtrl(1);
        return ;
    }

    if(vRunTime0 < (18*(1000/100)))  
    {
        SaveComm_CTimeCtrl(2);
        return ;
    }

    if(vRunTime0 < (22*(1000/100)))  
    {
        SaveComm_CTimeCtrl(3);
        return ;
    }
...
void  SaveComm_CTimeCtrl(uint8 vComm)
{
    ...
    if(vComm)
    {
        uint8 vState=GetState_CNodeInfo(vAddr);  
        uint8 vSendData=GetData_CLpAnsCtrl(vComm,vState);  
        
        SetAnsFlag_CLpScanCtrl();   
        if(vComm == 3)
        {
            uint8 vCkCyc=GetCkCyc_CNodeInfo(vAddr);   
            if(vCkCyc==2) 
            {
                vSendData=vAddr;
            }
            ...
            {
                vSendData=GetData_CLpAnsCtrl(1,vAddr);
            }
            else
            {
...
void  AnsCommT0_CTimeCtrl(void)
{
    ...
    if(GetReg_CNodeInfo(vAddr))     
    {
        if(GetState_CLpScanCtrl())  
        {
            return ;
        }
        
        if(vRunTime0 <= (1000/100))
        {
            if(!get_loopLD_state())
            {
...
#line 213 "..\\src\\CTimeCtrl\\CTimeCtrl.c"
            ...
            {
                if(GetAnsTId_CLpScanCtrl())  
                {
                    DecAnsTId_CLpScanCtrl();
                }
                else if(GetAnsStep_CLpScanCtrl() < 10)  
                {
...
void   T0Int_CTimeCtrl(void)
{
    if(GetExtint_CLpCkCtrl())  
    {
        if(GetExtint_CLpCkCtrl()==2)  
        {
            SetCommT0_CTimeCtrl();
        }
        else   
    ...
    IncT0Count_CTimeCtrl();  
    if(0==GetPer_CLpCkCtrl())   
    {

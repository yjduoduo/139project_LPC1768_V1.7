#line 1 "..\\src\\MenuCtrl\\runfunction.c"
...
void set_menu_alarm_info(alarminfo alarm_info)
{
    ...
    lcd_printf("------>>>>>>>set menu alarm info\n");
...
void menu_alarm_fire(void)
{
    ...
    if(current_alarmpart != get_menu_alarm_info()->part)
    {
        ...
        lcd_printf("fire alarm!!!\n");
        lcd_printf("current alarm part:%d\n",current_alarmpart);
        lcd_printf("alarm info part   :%d\n",get_menu_alarm_info()->part);
...
void DisplayKeyMenu(void)
{
    ...
    else if(GetMenuFlag() == (1))
    {
        ...
        if(Get_KeyValue() == 5)
        {
            lcd_printf("set MENU_RUN at MENU_FIREALARM\n");
            SetMenuFlag((2));
            Main_Menu(1);
        }
...
#line 647 "..\\src\\MenuCtrl\\runfunction.c"

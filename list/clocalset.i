...
uint16 HZ_SHOW(uint8* hz,uint8 num)
{
    if(0==num%2)
        ...
        lcd_printf("hz_show num not odd\n");
        return 0;
    }
}
...
void Local_Menu(uint8 local_addr0,uint8 local_addr1,uint8 local_addr2,uint8 depart0,uint8 depart1,uint8 depart2,uint8 selflag,uint8 sureFlag)
{
    ...
    if(selflag==1)
    {
        display_or_reverse(1,2,2,0 + (8),(local_addr0%10));
        display_or_reverse(0,2,2,8 + (8),(local_addr1%10));
        display_or_reverse(0,2,2,16 + (8),(local_addr2%10));
    ...
    {
        display_or_reverse(0,2,2,0 + (8),(local_addr0%10));
        display_or_reverse(1,2,2,8 + (8),(local_addr1%10));
        display_or_reverse(0,2,2,16 + (8),(local_addr2%10));
    ...
    else if(selflag==3)
    {
        display_or_reverse(0,2,2,0 + (8),(local_addr0%10));
        display_or_reverse(0,2,2,8 + (8),(local_addr1%10));
        display_or_reverse(1,2,2,16 + (8),(local_addr2%10));
    ...
    else if(0x02 == sureFlag)
    {
        menu_saving();
    }
    else if(0x03 == sureFlag)
    {
        menu_savetips();
    }
    else if(0x04 == sureFlag)
    {

...
#line 16 "..\\src\\MenuCtrl\\CTaskUp.c"
#line 1 "..\\src\\MenuCtrl\\CTaskUp.h"
...
#line 17 "..\\src\\MenuCtrl\\CTaskUp.c"
...
#line 18 "..\\src\\MenuCtrl\\CTaskUp.c"
...
#line 19 "..\\src\\MenuCtrl\\CTaskUp.c"
#line 1 "..\\src\\common\\CFlashParam.h"
...
#line 20 "..\\src\\MenuCtrl\\CTaskUp.c"
...
#line 21 "..\\src\\MenuCtrl\\CTaskUp.c"
...
#line 22 "..\\src\\MenuCtrl\\CTaskUp.c"
...
void reset_ok(void);
#line 23 "..\\src\\MenuCtrl\\CTaskUp.c"
...
#line 24 "..\\src\\MenuCtrl\\CTaskUp.c"
...
#line 25 "..\\src\\MenuCtrl\\CTaskUp.c"
...
void setup_localaddr_up(void)
{
    ...
    if(local_addr_value() != get_basic_localaddr())
        Local_Menu(GetBaseAddr(0),GetBaseAddr(1),GetBaseAddr(2),Get_zone_bit(0),
                   Get_zone_bit(1),Get_zone_bit(2),GetLocalParaSel(),0x03);
    else
        Local_Menu(GetBaseAddr(0),GetBaseAddr(1),GetBaseAddr(2),Get_zone_bit(0),
                   Get_zone_bit(1),Get_zone_bit(2),GetLocalParaSel(),0x00);
...
void setup_datetime_up(void)
{
    ...
    DateMod_Menu(GetYear(),GetMonth(),GetDay(),GetHour(),GetMintue(),GetSecond(),GetSelTime(),0x01);
...
void query_hist_up(void)
{
    ...
    if(--vHisCountDown < GetHistConter())
    {
        ...
        lcd_printf("vHisCountDown:%d\n",vHisCountDown);
        lcd_printf("history nums:%d\n",GetHistConter());
        lcd_printf("--->>look history xuhao:%d\n",tmp_num);
        if(tmp_num >= 0)
        {

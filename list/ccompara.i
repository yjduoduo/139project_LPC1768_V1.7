#line 1 "..\\src\\12UARTHandle\\CComPara.c"
...
#line 17 "..\\src\\12UARTHandle\\CComPara.c"
...
#line 18 "..\\src\\12UARTHandle\\CComPara.c"
#line 1 "..\\src\\common\\CFlashParam.h"
...
#line 19 "..\\src\\12UARTHandle\\CComPara.c"
...
#line 20 "..\\src\\12UARTHandle\\CComPara.c"
...
#line 21 "..\\src\\12UARTHandle\\CComPara.c"
...
void ReadHeart(void)
{
    ...
    {
        dataHeart[temp]= GetCom1Data0(temp);
    }
}
...
void data_from_data0(void)
{
    ...
    {
        data[dataCount][temp] =  GetCom1Data0(temp);
...
#line 76 "..\\src\\12UARTHandle\\CComPara.c"
...
void CompareCirAddr(void)
{
    ...
    for(i=(1);i<=50;i++)
    {
        if((get_comp_ciraddr(i)>CurrentValue)&&(get_comp_ciraddr(i)<0xff))
        {
            CurrentValue=get_comp_ciraddr(i);
            break;
        }
...
void Init_CirAddrInfo(void)
{
    uint8 CurrentValue=0;
    uint8 i;
    lcd_printf("init ciraddr info\n");
    for(i=(1);i<=50;i++)
    {
        if((get_comp_ciraddr(i)>CurrentValue)&&(get_comp_ciraddr(i)<=200))
        {
            lcd_printf("set ciraddr:%d,comp:%d\n",get_comp_ciraddr(i),i);

#line 1 "..\\src\\13CirCon\\CAddressCount.c"
...
#line 15 "..\\src\\13CirCon\\CAddressCount.c"
#line 1 "..\\src\\13CirCon\\CAddressCount.h"
...
void clr_weixialasignal(void);
void clr_xialasignal(void);
#line 16 "..\\src\\13CirCon\\CAddressCount.c"
...
#line 17 "..\\src\\13CirCon\\CAddressCount.c"
#line 1 "..\\src\\common\\CFlashParam.h"
...
#line 18 "..\\src\\13CirCon\\CAddressCount.c"
...
#line 19 "..\\src\\13CirCon\\CAddressCount.c"
...
#line 20 "..\\src\\13CirCon\\CAddressCount.c"
...
#line 21 "..\\src\\13CirCon\\CAddressCount.c"
...
#line 22 "..\\src\\13CirCon\\CAddressCount.c"
...
#line 23 "..\\src\\13CirCon\\CAddressCount.c"
...
#line 24 "..\\src\\13CirCon\\CAddressCount.c"
...
void reset_ok(void);
#line 25 "..\\src\\13CirCon\\CAddressCount.c"
...
volatile uint32 RisingCount=0;
volatile uint32 circuit_counter=0;
volatile uint8 vCirAddrv=0;
...
void Clr_Alarm(void)
{
    ...
    if(get_firealarm_nums()>0)
    {
        ...
        if(0 == (tmpnums++)%30){
            lcd_printf("Clr_Alarm:have fir alarms\n");
            lcd_printf("xia la val:%d\n",getxialasignal());
            lcd_printf("wei la val:%d\n",get_weixialasignal());

        }
        if(getxialasignal() >  50)
        {
            lcd_printf("xialasignal >4\n");
            if(get_weixialasignal() >20)
            {
                lcd_printf("-------reset alarm succ!!!\n");
                reset_ok();
...
#line 526 "..\\src\\13CirCon\\CAddressCount.c"
}

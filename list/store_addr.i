#line 1 "..\\src\\componentinfo\\store_addr.c"
...
#line 2 "..\\src\\componentinfo\\store_addr.c"
...
#line 3 "..\\src\\componentinfo\\store_addr.c"
...
#line 5 "..\\src\\componentinfo\\store_addr.c"
...
#line 6 "..\\src\\componentinfo\\store_addr.c"
#line 1 "..\\src\\common\\CFlashParam.h"
...
#line 7 "..\\src\\componentinfo\\store_addr.c"
...
{
    uint8 i,j;
    lcd_printf("====query component lists\n");
    lcd_printf("get node nums:%d\n",get_nodenums());
    ...
    for(i=(1);i<=50;i++)
    {
        ...
        {
            lcd_printf("note info 0~45 [%d]:",i);
            for(j=1;j<=45;j++)
            {
              lcd_printf("%d,",get_node_info(i,j));
            }
            lcd_printf("\n");
        }
        ...
        if((0xff) == get_comp_ciraddr(i))
            continue;
        if( get_comp_inzone(i) > 200)
        {
            lcd_printf("number:%d,inzone is:%d err!\n",i,get_comp_inzone(i));
            continue;
        }
        if(get_comp_partnumber(i) > 50)
        {
            lcd_printf("number:%d,partnumber is:%d err! part",i,get_comp_partnumber(i));
            continue;
        }

        lcd_printf("cir addr:%d,inzone:%d,partnumber:%d\n",get_comp_ciraddr(i),
              get_comp_inzone(i),get_comp_partnumber(i));
        lcd_printf("psn0~3:%d,%d,%d,%d\n",get_comp_psn0(i),
              get_comp_psn1(i),
              get_comp_psn2(i),
              get_comp_psn3(i));
        lcd_printf("masked:%d\n",get_mask_info(i));

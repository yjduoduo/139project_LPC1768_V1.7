#line 1 "..\\src\\Hardware\\Extint\\extint.c"
...
#line 15 "..\\src\\Hardware\\Extint\\extint.c"
#line 1 "..\\src\\13CirCon\\CAddressCount.h"
...
void clr_weixialasignal(void);
void clr_xialasignal(void);
#line 16 "..\\src\\Hardware\\Extint\\extint.c"
...
#line 17 "..\\src\\Hardware\\Extint\\extint.c"
...
#line 18 "..\\src\\Hardware\\Extint\\extint.c"
#line 1 "..\\src\\common\\CFlashParam.h"
...
#line 19 "..\\src\\Hardware\\Extint\\extint.c"
...
#line 21 "..\\src\\Hardware\\Extint\\extint.c"
...
void Eint_Dis(void)
{
    ...
    timern_disable(2);
    i2c0_disable();
    (*(volatile unsigned long *)(0x40028000 + 0x8C)) = 0xffff;
    pwm1_disable();
...
void cExt3IntClrFlow(void)
{
    (*(volatile unsigned long *)(0x40028000 + 0x8C)) |= (*(volatile unsigned long *)(0x40028000 + 0x88));
}
void cExt3IntClrRise(void)
{
    (*(volatile unsigned long *)(0x40028000 + 0x8C)) |= (*(volatile unsigned long *)(0x40028000 + 0x84));
}
...
void extint1_enable(void)
{
    ...
    NVIC_SetPriority(EINT1_IRQn, (0x05 << 3)); 
}
void extint1_disable(void)
{
...
void EINT1_IRQHandler (void)
{
    ...
    (*(volatile unsigned long *)(0x400FC000 + 0x140)) = 2;
    SetE1_flag();
    Eint_En();
}

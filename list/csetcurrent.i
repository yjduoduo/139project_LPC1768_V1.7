#line 1 "..\\src\\common\\CSetCurrent.c"
...
#line 15 "..\\src\\common\\CSetCurrent.c"
...
#line 16 "..\\src\\common\\CSetCurrent.c"
...
void State_6mA(void)
{
    (*(volatile unsigned long *)(0x2009C000 + 0x18))	|= ((1<<21));
    (*(volatile unsigned long *)(0x2009C000 + 0x1C)) |= ((1<<22));
}


void State_20mA(void)
{
    (*(volatile unsigned long *)(0x2009C000 + 0x1C)) |= ((1<<21)) | ((1<<22));
}
#line 44 "..\\src\\common\\CSetCurrent.c"

static uint8 loop_LD_counter = 0;



static uint8 state_loopLD[10];
...
uint32 get_loopLD_state(void)
{
    return (*(volatile unsigned long *)(0x2009C000 + 0x14)) & (1<<23);
}

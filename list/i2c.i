...
#line 18 "..\\src\\Hardware\\I2C\\i2c.c"
...
#line 19 "..\\src\\Hardware\\I2C\\i2c.c"
...
#line 20 "..\\src\\Hardware\\I2C\\i2c.c"
...
{
   (*(volatile unsigned long *)(0x400FC000 + 0x0C4)) |= (1 << 19);
      
   
	(*(volatile unsigned long *)(0x4002C000 + 0x04)) &= ~0x03C00000;
 	(*(volatile unsigned long *)(0x4002C000 + 0x04)) |= 0x01400000;

	 
  (*(volatile unsigned long *)(0x4001C000 + 0x18)) = (0x1<<2) | (0x1<<3) | (0x1<<5) | (0x1<<6);    

    if (ulFi2c>400000) ulFi2c = 400000;

    (*(volatile unsigned long *)(0x4001C000 + 0x10)) = (((12000000 * 8) / 4)/ulFi2c + 1) / 2;                                   
    (*(volatile unsigned long *)(0x4001C000 + 0x14)) = (((12000000 * 8) / 4)/ulFi2c) / 2;
    (*(volatile unsigned long *)(0x4001C000 + 0x18)) = 0x2C;
    (*(volatile unsigned long *)(0x4001C000 + 0x00)) = 0x40;                                                   
    
	
	  NVIC_EnableIRQ(I2C0_IRQn);

  (*(volatile unsigned long *)(0x4001C000 + 0x00)) = (0x1<<6);

  NVIC_SetPriority(UART1_IRQn, (0x03 << 3)); 
}
...
{                                                                        
    ...
    (*(volatile unsigned long *)(0x4001C000 + 0x18)) = 0x2C;
    (*(volatile unsigned long *)(0x4001C000 + 0x00)) = 0x60;                                                   
...
{                                                                        
    ...
    (*(volatile unsigned long *)(0x4005C000 + 0x18)) = 0x2C;
    (*(volatile unsigned long *)(0x4005C000 + 0x00)) = 0x60;                                                   
...
uint8 I2C_ReadNByte (uint8 sla, uint32 suba_type, uint32 suba, uint8 *s, uint32 num)
{
    ...
    {                                                                    
        ...
        (*(volatile unsigned long *)(0x4001C000 + 0x18)) = (1 << 2)|                                           
                     (1 << 3)|                                           
                     (1 << 5);                                           

                                                                         
        (*(volatile unsigned long *)(0x4001C000 + 0x00)) = (1 << 5)|                                           
                     (1 << 6);                                           
...
{   
    ...
    switch ((*(volatile unsigned long *)(0x4001C000 + 0x04)) & 0xF8)
    {    
        case 0x08:     
        if(I2C_suba_en == 1)                                   
        {   (*(volatile unsigned long *)(0x4001C000 + 0x08)) = I2C_sla & 0xFE;                                    
        }
        else                                                             
        {   (*(volatile unsigned long *)(0x4001C000 + 0x08)) = I2C_sla;                                           
        }
                                                                         
        (*(volatile unsigned long *)(0x4001C000 + 0x18)) = (1 << 3)|                                           
                     (1 << 5);                                           
        break;
        ...
        (*(volatile unsigned long *)(0x4001C000 + 0x08)) = I2C_sla;                                               
        (*(volatile unsigned long *)(0x4001C000 + 0x18)) = 0x28;                                               
        break;
        ...
        {
            if (I2C_num > 0)
            {    (*(volatile unsigned long *)(0x4001C000 + 0x08)) = *I2C_buf++;
                (*(volatile unsigned long *)(0x4001C000 + 0x18)) = 0x28;                                       
                I2C_num--;
            }
            else                                                         
            {                                                            
                (*(volatile unsigned long *)(0x4001C000 + 0x00)) = (1 << 4);                                   
                (*(volatile unsigned long *)(0x4001C000 + 0x18)) = 0x28;                                       
                I2C_end = 1;                                             
            }
        }
        ...
        {
            if (I2C_suba_num == 2)
            {   (*(volatile unsigned long *)(0x4001C000 + 0x08)) = ((I2C_suba >> 8) & 0xff);
                (*(volatile unsigned long *)(0x4001C000 + 0x18)) = 0x28;                                       
                I2C_suba_num--;
                break;
            }
            ...
            if(I2C_suba_num == 1)
            {   (*(volatile unsigned long *)(0x4001C000 + 0x08)) = (I2C_suba & 0xff);
                (*(volatile unsigned long *)(0x4001C000 + 0x18)) = 0x28;                                       
                I2C_suba_num--;
                break;
            }
            ...
            if (I2C_suba_num == 0)
            {
                (*(volatile unsigned long *)(0x4001C000 + 0x18)) = 0x08;
                (*(volatile unsigned long *)(0x4001C000 + 0x00)) = 0x20;
                I2C_suba_en = 0;                                         
                break;
            }
        }
        ...
        {    (*(volatile unsigned long *)(0x4001C000 + 0x00)) = 1 << 2;                                        
        }
        (*(volatile unsigned long *)(0x4001C000 + 0x18)) = 0x28;                                               
        break;
        ...
        case 0x50:                                                       
        *I2C_buf++ = (*(volatile unsigned long *)(0x4001C000 + 0x08));
        I2C_num--;
        if (I2C_num == 1)                                                
        {   (*(volatile unsigned long *)(0x4001C000 + 0x18)) = 0x2C;                                           
        }
        else
        {   (*(volatile unsigned long *)(0x4001C000 + 0x00)) = 0x04;                                           
            (*(volatile unsigned long *)(0x4001C000 + 0x18)) = 0x28;
        }
        break;
        ...
        case 0x58:                                                       
        *I2C_buf++ = (*(volatile unsigned long *)(0x4001C000 + 0x08));                                            
        (*(volatile unsigned long *)(0x4001C000 + 0x00)) = 0x10;                                               
        (*(volatile unsigned long *)(0x4001C000 + 0x18)) = 0x28;
        I2C_end = 1;
        break;

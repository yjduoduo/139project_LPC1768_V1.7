#line 1 "..\\src\\timesharectrl\\SysCtrl.c"
...
typedef union type_tSysRun{	   
  ...
  void  Set_CSys100msFlag(void);
  void  Clr_CSys100msFlag(void);
  uint8 Get_CSys100msFlag(void);
...
#line 3 "..\\src\\timesharectrl\\SysCtrl.c"

#line 12 "..\\src\\timesharectrl\\SysCtrl.c"
...
void  Set_CSys100usFlag(void)
{
    m_SysRun . Flag . b100us=1;
}

void  Clr_CSys100usFlag(void)
{
    m_SysRun . Flag . b100us=0;
}
uint8 Get_CSys100usFlag(void)
{
    return m_SysRun . Flag . b100us;
}

void   Set_CSys20msFlag(void)
{
    m_SysRun . Flag . b20ms=1;

}

void  Clr_CSys20msFlag(void)
{
    m_SysRun . Flag . b20ms=0;
}

uint8 Get_CSys20msFlag(void)
{
    return m_SysRun . Flag . b20ms;
}

  void  Set_CSys100msFlag(void)
{
    m_SysRun . Flag . b100ms=1;
}
  void  Clr_CSys100msFlag(void)
{
    m_SysRun . Flag . b100ms=0;
}
  uint8 Get_CSys100msFlag(void)
{
    return m_SysRun . Flag . b100ms;
}
...
void   Set_CSys500msFlag(void)
{
    m_SysRun . Flag . b500ms=1;

}

void  Clr_CSys500msFlag(void)
{
    m_SysRun . Flag . b500ms=0;
}

uint8 Get_CSys500msFlag(void)
{
    return m_SysRun . Flag . b500ms;
}

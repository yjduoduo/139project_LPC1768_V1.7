...
#define FLASHCFG      (*(volatile unsigned long *)(SCB_BASE_ADDR + 0x000))
...
#define CLKOUTCFG	   (*(volatile unsigned long *)(SCB_BASE_ADDR + 0x1C8))
...
#define RTC_AUXEN          (*(volatile unsigned long *)(RTC_BASE_ADDR + 0x58))
#define RTC_AUX            (*(volatile unsigned long *)(RTC_BASE_ADDR + 0x5c))
...
#define DEV_INT_STAT       (*(volatile unsigned long *)(USB_BASE_ADDR + 0x200))
#define DEV_INT_EN       (*(volatile unsigned long *)(USB_BASE_ADDR + 0x204))
#define DEV_INT_CLR    (*(volatile unsigned long *)(USB_BASE_ADDR + 0x208))
#define DEV_INT_SET      (*(volatile unsigned long *)(USB_BASE_ADDR + 0x20C))
#define DEV_INT_PRIO      (*(volatile unsigned long *)(USB_BASE_ADDR + 0x22C))

/* USB Device Endpoint Interrupt Registers */
#define EP_INT_STAT        (*(volatile unsigned long *)(USB_BASE_ADDR + 0x230))
#define EP_INT_EN       (*(volatile unsigned long *)(USB_BASE_ADDR + 0x234))
#define EP_INT_CLR       (*(volatile unsigned long *)(USB_BASE_ADDR + 0x238))
#define EP_INT_SET       (*(volatile unsigned long *)(USB_BASE_ADDR + 0x23C))
#define EP_INT_PRIO      (*(volatile unsigned long *)(USB_BASE_ADDR + 0x240))

/* USB Device Endpoint Realization Registers */
#define REALIZE_EP           (*(volatile unsigned long *)(USB_BASE_ADDR + 0x244))
#define EP_INDEX           (*(volatile unsigned long *)(USB_BASE_ADDR + 0x248))
#define MAXPACKET_SIZE       (*(volatile unsigned long *)(USB_BASE_ADDR + 0x24C))

/* USB Device SIE Command Reagisters */
#define CMD_CODE        (*(volatile unsigned long *)(USB_BASE_ADDR + 0x210))
#define CMD_DATA        (*(volatile unsigned long *)(USB_BASE_ADDR + 0x214))

/* USB Device Data Transfer Registers */
#define RX_DATA         (*(volatile unsigned long *)(USB_BASE_ADDR + 0x218))
#define TX_DATA         (*(volatile unsigned long *)(USB_BASE_ADDR + 0x21C))
#define RX_PLENGTH         (*(volatile unsigned long *)(USB_BASE_ADDR + 0x220))
#define TX_PLENGTH         (*(volatile unsigned long *)(USB_BASE_ADDR + 0x224))
#define USB_CTRL           (*(volatile unsigned long *)(USB_BASE_ADDR + 0x228))

/* USB Device DMA Registers */
#define DMA_REQ_STAT         (*(volatile unsigned long *)(USB_BASE_ADDR + 0x250))
#define DMA_REQ_CLR        (*(volatile unsigned long *)(USB_BASE_ADDR + 0x254))
#define DMA_REQ_SET        (*(volatile unsigned long *)(USB_BASE_ADDR + 0x258))
#define UDCA_HEAD          (*(volatile unsigned long *)(USB_BASE_ADDR + 0x280))
#define EP_DMA_STAT        (*(volatile unsigned long *)(USB_BASE_ADDR + 0x284))
#define EP_DMA_EN        (*(volatile unsigned long *)(USB_BASE_ADDR + 0x288))
#define EP_DMA_DIS      (*(volatile unsigned long *)(USB_BASE_ADDR + 0x28C))
#define DMA_INT_STAT       (*(volatile unsigned long *)(USB_BASE_ADDR + 0x290))
#define DMA_INT_EN       (*(volatile unsigned long *)(USB_BASE_ADDR + 0x294))
#define  EOT_INT_STAT       (*(volatile unsigned long *)(USB_BASE_ADDR + 0x2A0))
#define EOT_INT_CLR      (*(volatile unsigned long *)(USB_BASE_ADDR + 0x2A4))
#define EOT_INT_SET      (*(volatile unsigned long *)(USB_BASE_ADDR + 0x2A8))
#define  NDD_REQ_INT_STAT     (*(volatile unsigned long *)(USB_BASE_ADDR + 0x2AC))
#define NDD_REQ_INT_CLR    (*(volatile unsigned long *)(USB_BASE_ADDR + 0x2B0))
#define NDD_REQ_INT_SET     (*(volatile unsigned long *)(USB_BASE_ADDR + 0x2B4))
#define SYS_ERR_INT_STAT    (*(volatile unsigned long *)(USB_BASE_ADDR + 0x2B8))
#define SYS_ERR_INT_CLR  (*(volatile unsigned long *)(USB_BASE_ADDR + 0x2BC))
#define SYS_ERR_INT_SET   (*(volatile unsigned long *)(USB_BASE_ADDR + 0x2C0))
...
/* USB OTG Registers */
#define OTG_INT_STAT       (*(volatile unsigned long *)(USB_BASE_ADDR + 0x100))
#define OTG_INT_EN        (*(volatile unsigned long *)(USB_BASE_ADDR + 0x104))
#define OTG_INT_SET      (*(volatile unsigned long *)(USB_BASE_ADDR + 0x108))
#define OTG_INT_CLR      (*(volatile unsigned long *)(USB_BASE_ADDR + 0x10C))

#define		OTG_STAT_CTRL	 (*(volatile unsigned long *)(USB_BASE_ADDR + 0x110))
//#define OTG_Int_Ctrl     (*(volatile unsigned long *)(USB_BASE_ADDR + 0x110))
//#define OTG_Tmr         (*(volatile unsigned long *)(USB_BASE_ADDR + 0x114))
#define	   OTG_TIMER      (*(volatile unsigned long *)(USB_BASE_ADDR + 0x114))
/* USB OTG I2C Registers */
#define OTG_I2C_RX         (*(volatile unsigned long *)(USB_BASE_ADDR + 0x300))
#define OTG_I2C_TX         (*(volatile unsigned long *)(USB_BASE_ADDR + 0x300))
#define OTG_I2C_STS        (*(volatile unsigned long *)(USB_BASE_ADDR + 0x304))
#define OTG_I2C_CTL        (*(volatile unsigned long *)(USB_BASE_ADDR + 0x308))
#define OTG_I2C_CLKHI      (*(volatile unsigned long *)(USB_BASE_ADDR + 0x30C))
#define OTG_I2C_CLKLO      (*(volatile unsigned long *)(USB_BASE_ADDR + 0x310))

/* USB OTG Clock Control Registers */
#define OTG_CLK_CTRL     (*(volatile unsigned long *)(USB_BASE_ADDR + 0xFF4))
#define OTG_CLK_STAT      (*(volatile unsigned long *)(USB_BASE_ADDR + 0xFF8))

/*******新添加USB**********************/
#define USB_CLK_CTRL     (*(volatile unsigned long *)(USB_BASE_ADDR + 0xFF4))
#define USB_CLK_STAT      (*(volatile unsigned long *)(USB_BASE_ADDR + 0xFF8))
/* Ethernet MAC */
